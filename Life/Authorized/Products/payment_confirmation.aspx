<%@ Page Language="C#" AutoEventWireup="true" CodeFile="payment_confirmation.aspx.cs" Inherits="General_Authorized_Products_payment_confirmation" %>
...
<body>
    ...
    <% Properties accPro = new Properties("life"); 

     Response.Write("<form id=\"payment_confirmation\" action=\""+accPro.HostUrl+"\" method=\"post\" runat=\"server\"/>");
        %>
...
<script>
    ...
    <%
        ...
        try {
            Response.Write("<input type=\"hidden\" id=\"signature\" name=\"signature\" value=\"" + Security.sign(parameters,"L") + "\"/>\n");

        }
        catch
        {
            //Response.Redirect("/Life/Authorized/Products/Payment.aspx");
        ...
        Response.Write("<div>");
        Response.Write("<strong><p style=\"text-align:center;\"><font color=\"blue\">Payment Amount : </font>" + Request.Params["amount"] + "</p></strong>");
        Response.Write("</div>");
        Response.Write("<div>");
        Response.Write("<strong><p style=\"text-align:center;\"><font color=\"blue\">Currency :  </font>" + Request.Params["currency"] + "</p></strong>");
        Response.Write("</div>");

   %>

   <p style="text-align:center;"><input type="submit" id="submit" value="Confirm" class="btn btn-primary"/></p>
        </div>
