<%@ Page Title="" Language="C#" MasterPageFile="~/Life.master" AutoEventWireup="true" CodeFile="Payment_Amex.aspx.cs" Inherits="Life_Authorized_Products_Payment_Amex" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
     ...
     <%--                     <asp:ScriptManager ID="ScriptManager1" runat="server">
                         ...
                         <asp:UpdatePanel runat="server" ID="updatescale"  UpdateMode="Conditional">
            <ContentTemplate>--%>
                         <div class="row">
           ...
           <%--     </ContentTemplate>
                              ...
                              <Triggers>
        <asp:AsyncPostBackTrigger ControlID="rdbPayMethod" EventName="SelectedIndexChanged" />
                        </Triggers>
                             </asp:UpdatePanel>--%>
     <%--    </ContentTemplate>
    <Triggers>
...
<asp:AsyncPostBackTrigger ControlID="btn_PayWithBOC" />
    
<asp:AsyncPostBackTrigger ControlID="btn_Amex" />
    --%>
</Triggers>
</asp:UpdatePanel>
