<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Life.master" CodeFile="BOC_PaymentForm.aspx.cs" Inherits="Life_Authorized_Products_BOC_PaymentForm" %>
...
<%--Test--%>
<%--<form id ="boc_IPG" action="https://test-bankofceylon.mtf.gateway.mastercard.com/api/nvp/40" method="post" style="min-height:600px">--%>
...
<%--        <p style="text-align:center;"><input type="button" value="Pay with Lightbox" onclick="Checkout.showLightbox();" /></p>--%>
        <p style="text-align:center;"><input type="button" value="Pay" 
                onclick="Checkout.showPaymentPage();" <%--style="width: 60px; height: 31px" --%> class="btn btn-primary"/></p>
