<%@ Page Title="" Language="C#" MasterPageFile="~/Life.master" AutoEventWireup="true" CodeFile="PayReceipt.aspx.cs" Inherits="Life_Authorized_Products_PayReceipt" %>
            ...
            <div class="row">
                ...
                <asp:Panel ID="Panel4" runat="server" Visible="False" Style="border:thin solid; border-color: #000000;
                    ...
                    <div class="row">
                       ...
                       <div class="col-xs-4"></div>
                        <div class="col-xs-4" style="text-align: center">
                            <asp:Image ID="Image4" class="img-responsive img-center" runat="server" ImageUrl="~/images/logo.png"  style="text-align: center"/>
                        </div>
                       <div class="col-xs-4"></div>
                        </div>
                        </div>
                ...
                <asp:Panel ID="Panel5" runat="server" Visible="False" Style="border:thin solid; border-color: #000000;
                    ...
                    <div class="row">
                       ...
                       <div class="col-xs-4"></div>
                        <div class="col-xs-4" style="text-align: center">
                            <asp:Image ID="Image5" class="img-responsive img-center" runat="server" ImageUrl="~/images/logo.png"  style="text-align: center"/>
                        </div>
                       <div class="col-xs-4"></div>
                        </div>
                        </div>
                    ...
                    <%
                        if (!ltrPolFee_addr2.Text.Equals(""))
                        {
                         %>
                    <div class="row">
                        <div class="col-xs-1">
                    ...
                    <%
                        ...
                        if (!ltrPolFee_addr3.Text.Equals(""))
                        {
                         %>
                    <div class="row">
                        <div class="col-xs-1">
                    ...
                    <%
                        ...
                        if (!ltrPolFee_addr4.Text.Equals(""))
                        { 
                             %>
                    <div class="row">
                        <div class="col-xs-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-10">
                            <br />
                            <br />
                            <span class="style1">This is a computer generated letter and no signature eeeeee
                            required.</span></div>
                        <div class="col-xs-1">
                        </div>
                    </div>
