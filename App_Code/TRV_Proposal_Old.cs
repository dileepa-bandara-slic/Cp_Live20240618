...
public class TRV_Proposal_Old
{
    ...
    public TRV_Proposal_Old()
    {
        //
        // TODO: Add constructor logic here
        //
    }
    public TRV_Proposal_Old(string proposal_ID)
    {
        try
        {
    ...
    public TRV_Proposal_Old(string proposal_ID,int i)
    {
    ...
    public void DrawTable(GridView gvPlanDetails,string Refno, double premium_as25, double premium_bsc1, double premium_bsc2, double premium_std1, double premium_std2, double premium_est1, double premium_est2, double premium_est3)
    {
        ...
        hlPrAS25.CssClass = "btn btn-primary btn-print";
        ...
        hlPrBSC1.CssClass = "btn btn-primary btn-print";
        //hlPrBSC1.Width = 50;
        ...
        hlPrBSC2.CssClass = "btn btn-primary btn-print";
        ...
        hlPrSTD1.CssClass = "btn btn-primary btn-print";
        ...
        hlPrSTD2.CssClass = "btn btn-primary btn-print";
        ...
        hlPrEST1.CssClass = "btn btn-primary btn-print";
        ...
        hlPrEST2.CssClass = "btn btn-primary btn-print";
        ...
        hlPrEST3.CssClass = "btn btn-primary btn-print";
        ...
        hlByAS25.CssClass = "btn btn-primary btn-xx";
        ...
        hlByBSC1.CssClass = "btn btn-primary btn-xx";
        ...
        hlByBSC2.CssClass = "btn btn-primary btn-xx";
        ...
        hlBySTD1.CssClass = "btn btn-primary btn-xx";
        ...
        hlBySTD2.CssClass = "btn btn-primary btn-xx";
        ...
        //hlByEST1.Width = 50;
        hlByEST1.CssClass = "btn btn-primary btn-xx";
        ...
        hlByEST2.CssClass = "btn btn-primary btn-xx";
        ...
        hlByEST3.CssClass = "btn btn-primary btn-xx";
        ...
        try
        {
            ...
            if (dsPlans != null)
            {
                ...
                for (int i = 0; i < dtPlans.Rows.Count; i++)
                {
                    ...
                    string[] arrcntry = visitingCountries.Rows[0].ItemArray[1].ToString().Split(',');
