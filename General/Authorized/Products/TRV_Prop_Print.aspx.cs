...
public partial class General_Authorized_Products_TRV_Prop_Print : System.Web.UI.Page
{
        ...
        else
        {
            ...
            else
            {
                ...
                if (paraList.ContainsKey("plan") && paraList.ContainsKey("refNo") && paraList.ContainsKey("action"))
                {
                    ...
                    string mesg = prop.updateTRVProposal(plan, refid);
                    ...
                    if (mesg == "success")
                    {
                        ...
                        {
                            TRV_print_pdf pdfPrint = new TRV_print_pdf();
