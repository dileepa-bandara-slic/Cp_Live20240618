<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="ClientHome.aspx.cs" Inherits="General_Authorized_Products_ClientHome" %>
 ...
 <div class="main-container" id="main-container" style="min-height:600px">
  ...
  <legend>Add Policies:</legend>
            ...
            <div class="row">
                ...
                <div class="col-xs-10">
                    <div class="alert alert-warning" id="p_messages" style="display: none;">
            ...
            <div class="row">
                ...
                <div class="col-xs-10">
                    <asp:GridView ID="GridPendPols" runat="server" AutoGenerateColumns="False" CssClass="footable">
                        <Columns>
                            ...
                            <asp:BoundField DataField="SUM_ASSURD" HeaderText="Sum assured (Rs.)" ItemStyle-HorizontalAlign="Right"
