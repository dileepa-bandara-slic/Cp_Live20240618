...
public partial class General_Authorized_Products_TRV_Proposal : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
            ...
            CategoryValidator.IsValid && GenderValidator.IsValid && DOBValidator.IsValid)
        {
            ...
            try
            {
                ...
                TRV_InfoValidator validator = new TRV_InfoValidator();
                string mesg = "success";
                mesg = validator.validateMinMaxAgeForTRV(Page.User.Identity.Name.ToUpper(), ddlCategory.SelectedValue.ToString(), "6 Month", "80Y", txtDOB.Text, txtFrmDate.Text.Trim(), txtToDate.Text.Trim(), out age);
