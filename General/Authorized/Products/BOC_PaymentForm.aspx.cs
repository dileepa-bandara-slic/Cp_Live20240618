...
public partial class General_Authorized_Products_BOC_PaymentForm : System.Web.UI.Page
{
    ...
    private string[] responseParamterList;   
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            if (count_PageLoad == 0)
            {
                //Merchant Related Variables -Test
                //hdf_merchantId.Value = "700163000047";
                //hdf_apiUserName.Value = "Merchant.700163000047";
                //hdf_apiPassword.Value = "e2b54c964c3603bef13f043cd202def6";
                //version = "40";
                ////gatewayUrl = "https://test-bankofceylon.mtf.gateway.mastercard.com/api/nvp";


                /*Merchant Related Variables - Live*/
                hdf_merchantId.Value = "700163000047";
                hdf_apiUserName.Value = "Merchant.700163000047";
                hdf_apiPassword.Value = "85dced7bcb339e506e885ad14a1ad3b4";
                version = "50";
    ...
    private void SendRequestToServer()
    {
       ...
       // WebRequest request = WebRequest.Create("https://test-bankofceylon.mtf.gateway.mastercard.com/api/nvp/version/40");
        ...
        using (dataStream = response.GetResponseStream())
        {
            ...
            responseParamterList = responseParamterString.Split('&');
            foreach (string param_Values in responseParamterList)
            {
        ...
        // Close the response.  
        response.Close();
        //Insert General Payments Details
        if(result){
        insertBOCPayment();
        }
        else
    ...
    private void insertBOCPayment()
    {
        ...
        bool isInitialInsertSuccess = insertInitialOrderDetail_obj.Insert_BOCPaymentDetails_Gen((hdf_order_id.Value), hdf_order_amount.Value, hdf_order_currency.Value, hdf_orderRef.Value, hdf_sessionID.Value, hdf_SuccessIndicator.Value);
        ...
        //    log logger = new log();
        //    logger.write_log("Failed at BOC_PaymentForm-Pageload:Unsuccessful Insertion To SLIC_NET.BOC_IPG_PAYMENTS DB. ");
