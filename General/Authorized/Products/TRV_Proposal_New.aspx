<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="TRV_Proposal_New.aspx.cs"
    Inherits="General_Authorized_Products_TRV_Proposal_New" MaintainScrollPositionOnPostback="true" smartNavigation="true"%>
...
<%--            <script type="text/javascript">
  ...
  <legend>Travel Protect - Quotation :</legend>
                        ...
                        <font color="dodgerblue" face="sans-serif" size="2"><b>For any special notes required by Embassy/High commission, please contact Sri Lanka Insurance Corporation General Ltd Hot Line - 011 235 7357, to contact Head office</b></font>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="From Sri Lanka">
                                                            <ItemTemplate>
                                                                    ...
                                                                    <asp:DropDownList ID="ddlFrmCntry" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddlFrmCntry_SelectedIndexChanged">
                         ...
                         <div class="row">
                                 <div class="col-sm-12">
                         <asp:Label ID="lblErrMesg1" runat="server" ForeColor="Red"></asp:Label>
                                     </div>
                             </div>
                          ...
                          <div class="row">
                                        ...
                                        <div class="row">
                                               ...
                                               <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary btn-xs" OnClick="btnSubmit_Click"
 ...
 <%--  <div class="auto-style2">--%>
    ...
    <%--                            <asp:GridView runat="server" ID="gvPlanDetails" AutoGenerateColumns="False" CellPadding="10"
                                    CellSpacing="10" OnRowDataBound="gvPlanDetails_RowDataBound" CssClass="col-md-12 table-bordered table-striped table-condensed cf">--%>
                                                            ...
                                                            <asp:GridView runat="server" ID="gvPlanDetails" AutoGenerateColumns="False" CellPadding="10"
                                    CellSpacing="10" OnRowDataBound="gvPlanDetails_RowDataBound" class="col-md-12 table-bordered table-striped table-condensed cf">
                                    <Columns>
                ...
                CssClass="btn btn-primary btn-xs" Visible="False">Terms & Conditions</asp:HyperLink>                     
                        </div>
                    </div>
                <br />
