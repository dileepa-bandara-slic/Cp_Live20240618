...
public partial class General_Authorized_Products_Payment_Confirmation_Amex : System.Web.UI.Page
{
    ...
    public void encryptData()
    {
        ...
        try
        {
            ...
            string x = objIShroff.getErrorCode();
            string b = objIShroff.getErrorMessage();
            if (bResult)
            {
