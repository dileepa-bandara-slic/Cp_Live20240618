<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="PayReceipt_Amex.aspx.cs" Inherits="General_Authorized_Products_PayReceipt_Amex" %>
    ...
    <div class="modal-content  modal-sm">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
            ...
            <div class="row">
                     <asp:Panel ID="Panel3" runat="server"  style="border:thin solid; border-color: #000000; margin-left: 5%; margin-right: 5%; display:none;">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 672px; height: 124px;">
            <tr>
                <td style="height: 19px" align="center" width="100%">
                    <span style="color: #330099; font-family:verdana;font-size:small"><b>Transaction Response Page</b></span></td>
            </tr>
            <tr>
                <td style="height: 19px">&nbsp;</td>
            </tr>
            <tr>
                <td style="width: 672px" id="tdResult" runat="server">
                </td>
            </tr>
            ...
            <tr>
                <td style="height: 19px">&nbsp;</td>
                    ...
                    <table style="width: 600px">
                            <tr>
                                <td style="height: 21px" valign="top" width="163">
                                </td>
                                <td style="height: 21px" width="427">
                                </td>
                            </tr>
                            <tr>
                                <td valign="top" width="163">
                                    Plain Text Receipt</td>
                                <td width="427">
                                    <asp:TextBox ID="txtPlainReceipt" runat="server" TextMode="MultiLine" Width="410px"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td valign="top" width="163">
                                    Encrypted Receipt</td>
                                <td width="427">
                                    <asp:TextBox ID="encryptedReceipt" runat="server" TextMode="MultiLine" Width="410px"></asp:TextBox></td>
                            </tr>
                        </table>
